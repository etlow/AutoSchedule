...
public class AfterTimePicker extends DialogFragment implements TimePickerDialog.OnTimeSetListener{
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState){
        ...
        tvTitle.setText("Avoid lessons after...");
    ...
    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
        String text = String.format("Avoid lessons after %d:%02d.", hourOfDay, minute);
        lf.addItem(text, new AvoidLessonsAfterPriority(0, hourOfDay));
    }
}
